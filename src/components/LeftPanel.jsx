...
const LeftPanel = ({ setIsModalOpen }) => (
  <div className=" rounded text-center flex flex-col items-center justify-around gap-2">
    ...
    <GradientCardWrapper
      className={"h-[240px] w-64 text-left hover:cursor-pointer"}
    >
      <div className="z-10 text-center" onClick={() => setIsModalOpen(true)}>
    ...
    <GradientCardWrapper className={"h-[120px] w-64 justify-center"}>
      <button className="relative bg-gradient-to-r from-[#A879F5] to-[#743EE0] text-white font-medium px-8 py-4 rounded-full flex items-center gap-2 text-lg shadow-inner shadow-[#0e0e1d]">
