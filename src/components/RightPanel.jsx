import { FaCamera, FaMagic, FaRedo, FaFilePdf } from "react-icons/fa";
...
const RightPanel = () => (
  <div className="rounded text-center flex flex-col items-center justify-around gap-2">
    ...
    {/* Prompt Service */}
    <div className="bg-[#1B1B2D] text-white rounded-3xl p-6 w-72 shadow-lg relative overflow-hidden flex flex-col justify-between h-[400px]">
